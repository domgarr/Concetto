package com.domgarr.concetto.repositories;
...
public interface ConceptRepository extends JpaRepository<Concept, Long> {
    ...
    @Query(value="select count(*) from concept  where datediff( curdate(),next_review_date) > 0 AND user_id = :userId AND done = true", nativeQuery = true)
