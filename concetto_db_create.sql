create table concept (id bigint not null auto_increment, date_created datetime, done bit not null, explanation varchar(255), name varchar(100), next_review_date datetime, reviewed bit not null, simplified bit not null, inter_interval_id bigint not null, subject_id bigint not null, user_id bigint not null, primary key (id)) engine=InnoDB
...
create table subject (id bigint not null auto_increment, count integer not null, last_update datetime, name varchar(100) not null, next_review_date datetime, review_count integer not null, user_id bigint not null, primary key (id)) engine=InnoDB
