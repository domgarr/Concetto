create table concept (id bigint not null auto_increment, date_created datetime, date_last_reviewed datetime, done bit not null, explanation varchar(255) not null, name varchar(100), reviewed bit not null, simplified bit not null, interval_id bigint not null, subject_id bigint not null, user_id bigint not null, primary key (id)) engine=InnoDB
...
alter table concept add constraint FKqq1kvwnjlfv7l6fg670k7l3ss foreign key (interval_id) references inter_interval (id)
